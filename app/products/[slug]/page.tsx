    ...
    <div className="min-h-screen">
      ...
      <div className="container-custom py-16">
        ...
        <div className="flex flex-wrap gap-4 mb-16">
          ...
          <Link href={(product as any).discordUrl || "https://discord.com/invite/BJTZSs3"} target="_blank" rel="noopener noreferrer">
            <Button variant="secondary" size="lg">
              Join Discord
            </Button>
          </Link>
              ...
              <div className="flex items-start gap-6">
                ...
                <div className="flex-1">
                  ...
                  <div className="grid md:grid-cols-3 gap-4">
                    ...
                    {/* Discord link - only show if URL exists */}
                    {(product as any).discordUrl && (
                      <Link 
                        href={(product as any).discordUrl}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex items-center gap-3 p-4 bg-background rounded-lg border border-border hover:border-primary transition-colors group"
                      >
