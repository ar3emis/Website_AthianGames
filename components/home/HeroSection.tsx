          ...
          <div className="lg:col-span-5">
            ...
            <div className="inline-flex items-center px-4 py-2 mb-8 bg-purple-500/10 border border-purple-500/20 rounded-full">
              ...
              <span className="text-sm font-medium text-purple-400">
                Game Studio &amp; Unreal Engine Creators
              </span>
            </div>
            ...
            <h1 className="mb-6 text-5xl md:text-6xl font-bold text-white leading-tight">
              ...
              <span className="bg-gradient-to-r from-purple-400 via-pink-400 to-cyan-400 bg-clip-text text-transparent">
                Pro Unreal Engine Tools
              </span>
            </h1>

            {/* Subheading */}
            <p className="text-lg md:text-xl text-gray-300 mb-10 leading-relaxed max-w-xl">
              Athian Games makes story-driven worlds like{" "}
              <span className="text-white">A Tale of Miss Valentina</span> — and
              turns the systems, shaders and VFX built along the way into polished
              tools you can drop straight into your own Unreal Engine project.
            </p>
