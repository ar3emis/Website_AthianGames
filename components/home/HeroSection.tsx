        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-5">
            ...
            <p className="text-lg md:text-xl text-gray-300 mb-10 leading-relaxed max-w-xl">
              Athian Games builds original games, cinematic worlds, and
              production-ready Unreal Engine products from the same studio
              pipeline. Explore upcoming game projects alongside the systems,
              characters, shaders, and VFX created for real production.
            </p>
